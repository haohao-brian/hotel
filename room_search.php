...
<?php
  ...
  $_SESSION["number"] = $_POST["number"];
    ...
    // 建立SQL指令字串
    $sql1 = "(SELECT 訂單.房間ID FROM 訂單,房間 WHERE 訂單.房間ID = 房間.房間ID AND 訂單.Check_out_時間>='";
    $sql1.= $in_time."'AND 訂單.Check_out_時間 <='";
    $sql1.= $out_time."')";

    $sql2 = "(SELECT 訂單.房間ID FROM 訂單,房間 WHERE 訂單.房間ID = 房間.房間ID AND 訂單.Check_in_時間<='";
    $sql2.= $out_time."'AND 訂單.Check_in_時間 >='";
    $sql2.= $in_time."')";

    $sql3 = "(SELECT 訂單.房間ID FROM 訂單,房間 WHERE 訂單.房間ID = 房間.房間ID AND 訂單.Check_in_時間<='";
    $sql3.= $in_time."'AND 訂單.Check_out_時間 >='";
    $sql3.= $out_time."')";
